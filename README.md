...
> [!TIP]
> При добавлении или настройке профиля вы можете нажать на иконку настроек (шестерёнку) рядом с ним и выбрать **VPN с дополнительной безопасностью WARP** для повышения стабильности и конфиденциальности подключения.
